...
const Sidebar: React.FC<SidebarProps> = ({ sessions, currentSessionId, language, onNewChat, onSelectSession }) => {
  ...
  return (
    <div className="w-64 h-full bg-[#f8f9fa] border-r border-gray-200 flex flex-col p-4">
      <button
        onClick={onNewChat}
        className="flex items-center gap-3 px-4 py-3 mb-6 bg-white border border-gray-200 rounded-full hover:shadow-md transition-shadow text-sm font-medium text-gray-700"
      >
